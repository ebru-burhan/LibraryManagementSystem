...
namespace Library.DataAccess.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "MembershipApplicationStatuses",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MembershipApplicationStatuses", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BookCopies_BookStatuses_StatusId",
                        column: x => x.StatusId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PasswordHash = table.Column<byte[]>(type: "varbinary(max)", nullable: false),
                    PasswordSalt = table.Column<byte[]>(type: "varbinary(max)", nullable: false),
                    IsKvkkApproved = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MembershipApplications_MembershipApplicationStatuses_ApplicationStatusId",
                        column: x => x.ApplicationStatusId,
                        principalTable: "MembershipApplicationStatuses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LostBooks_BookCopies_BookCopyId",
                        column: x => x.BookCopyId,
                        principalTable: "BookCopies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_LostBooks_Members_MemberId",
                        column: x => x.MemberId,
                        principalTable: "Members",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MemberFavorites_Books_BookId",
                        column: x => x.BookId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MemberReadingStatuses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MemberReadingStatuses_Books_BookId",
                        column: x => x.BookId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MemberReadingStatuses_Members_MemberId",
                        column: x => x.MemberId,
                        principalTable: "Members",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LoanStatuses_Code",
                table: "LoanStatuses",
                column: "Code",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_LostBooks_BookCopyId",
                table: "LostBooks",
                column: "BookCopyId");

            migrationBuilder.CreateIndex(
                name: "IX_LostBooks_MemberId",
                table: "LostBooks",
                column: "MemberId");

            migrationBuilder.CreateIndex(
                name: "IX_MemberFavorites_BookId",
                table: "MemberFavorites",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_MemberFavorites_MemberId_BookId",
                table: "MemberFavorites",
                columns: new[] { "MemberId", "BookId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_MemberReadingStatuses_BookId",
                table: "MemberReadingStatuses",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_MemberReadingStatuses_MemberId_BookId",
                table: "MemberReadingStatuses",
                columns: new[] { "MemberId", "BookId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MembershipApplications_ApplicationStatusId",
                table: "MembershipApplications",
                column: "ApplicationStatusId");

            migrationBuilder.CreateIndex(
                name: "IX_MembershipApplications_IdentityNumber",
                table: "MembershipApplications",
                column: "IdentityNumber",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_MembershipApplicationStatuses_Code",
                table: "MembershipApplicationStatuses",
                column: "Code",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reservations_MemberId_BookId_StatusId",
                table: "Reservations",
                columns: new[] { "MemberId", "BookId", "StatusId" },
                unique: true,
                filter: "[StatusId] = 1");
